...
async def _inject_preempt_message(ctx: HookContext, ls: Any) -> None:
    ...
    supervisor. Purpose: keep Preempt V2 behavior identical after extraction.
    """
